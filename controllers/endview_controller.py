...
class EndviewController:
    ...
    def set_nde_contrast(self, contrast: float) -> None:
        self.standard_view.set_nde_contrast(float(contrast))
        if self.corrosion_view is not None:
            self.corrosion_view.set_nde_contrast(float(contrast))
        if self.secondary_view is not None:
            self.secondary_view.set_nde_contrast(float(contrast))
        if self.secondary_corrosion_view is not None:
