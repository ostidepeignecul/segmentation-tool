...
class DockLayoutController:
    ...
    def __init__(self, *, main_window: QMainWindow) -> None:
        ...
        self.ucoordinate_dock = ads.CDockWidget("D-Scan")
        self.vcoordinate_dock = ads.CDockWidget("B-Scan")
    ...
    def _configure_docks(self) -> None:
        ...
        self.ucoordinate_dock.setWindowTitle("D-Scan")
        self.vcoordinate_dock.setObjectName("dock_vcoordinate")
        self.vcoordinate_dock.setWindowTitle("B-Scan")
