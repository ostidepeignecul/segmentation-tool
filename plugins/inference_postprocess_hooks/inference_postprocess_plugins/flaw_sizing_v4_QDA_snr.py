from sentinelai.models.Swin_UNETR.data_processing.flaw_sizing_methods.maskSizing_v4_QDA_snr import (
    adjust_mask,
)
...
class FlawSizingv4_QDA_snr(FlawSizingBase):
    def __init__(self):
        super().__init__(
            mask_adjustment_method=adjust_mask,
            inference_id="flaw_sizing_v4_QDA_snr",
            csv_output="./indication_table_{status_info['gr']}_v4_QDA_snr.csv",
        )
