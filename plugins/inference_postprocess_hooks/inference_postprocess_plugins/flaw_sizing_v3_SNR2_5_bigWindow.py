...
class FlawSizingv3_SNR2_5_bigWindow(PostprocessPlugin):
    def process_inference_result(
        ...
        self.inference_id = "flaw_sizing_v3 SNR=2.5 bigWindow"
    ...
    def generate_adjusted_indications(
        ...
        adjusted_indication_table.to_csv(
            f"./indication_table_{group_index}_SNR=2_5_bigWindow.csv"
        )
