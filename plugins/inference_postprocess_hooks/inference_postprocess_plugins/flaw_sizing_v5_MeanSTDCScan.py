from sentinelai.models.Swin_UNETR.data_processing.flaw_sizing_methods.maskSizing_v5_MeanSTDCScan import (
    adjust_mask,
)
...
class FlawSizingv5_MeanSTDCScan(FlawSizingBase):
    def __init__(self):
        super().__init__(
            mask_adjustment_method=adjust_mask,
            inference_id="flaw_sizing_v5_MeanSTDCScan",
            csv_output="indication_table_{status_info['gr']}_v5_MeanSTDCScan",
        )
