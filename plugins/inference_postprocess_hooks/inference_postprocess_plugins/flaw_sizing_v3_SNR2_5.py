...
from sentinelai.models.Swin_UNETR.data_processing.flaw_sizing_methods.maskSizing_v3 import (
    adjust_mask,
)
...
class FlawSizingv3_SNR2_5(PostprocessPlugin):
    def process_inference_result(
        ...
        self.inference_id = "flaw_sizing_v3 SNR=2.5"
    ...
    def generate_adjusted_indications(
        ...
        if adjusted_indication_table is not None:
        ...
        adjusted_indication_table.to_csv(
            f"./indication_table_{group_index}_SNR=2_5.csv"
        )
