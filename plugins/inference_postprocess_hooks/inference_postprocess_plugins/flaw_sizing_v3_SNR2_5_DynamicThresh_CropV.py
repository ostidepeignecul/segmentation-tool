...
from sentinelai.models.Swin_UNETR.data_processing.flaw_sizing_methods.maskSizing_v3_DynamicThreshCropV import (
    adjust_mask,
)
...
class FlawSizingv3_SNR2_5_DynamicThreshCropV(PostprocessPlugin):
    def process_inference_result(
        ...
        self.inference_id = "flaw_sizing_v3 SNR=2.5 Dynamic Thresh CropV"
    ...
    def generate_adjusted_indications(
        ...
        adjusted_indication_table.to_csv(
            f"./indication_table_{group_index}_SNR=2_5_DynamicThresh CropV.csv"
        )
