...
from sentinelai.models.Swin_UNETR.data_processing.flaw_sizing_methods.maskSizing_v4 import (
    adjust_mask,
)
...
class FlawSizingv4(PostprocessPlugin):
    def process_inference_result(
        ...
        self.inference_id = "flaw_sizing_v4"
    ...
    def generate_adjusted_indications(
        ...
        adjusted_indication_table.to_csv(f"./indication_table_{group_index}_v4.csv")
