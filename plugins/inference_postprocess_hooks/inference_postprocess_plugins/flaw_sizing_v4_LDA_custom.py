...
from sentinelai.models.Swin_UNETR.data_processing.flaw_sizing_methods.maskSizing_v4_LDA_custom import (
    adjust_mask,
)
...
class FlawSizingv4_LDA_custom(PostprocessPlugin):
    def process_inference_result(
        ...
        self.inference_id = "flaw_sizing_v4_LDA_custom"
    ...
    def generate_adjusted_indications(
        ...
        adjusted_indication_table.to_csv(f"./indication_table_{group_index}_v4_QDA.csv")
